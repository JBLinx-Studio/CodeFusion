              ...
              <div className="text-center text-[#64748b] space-y-4">
                ...
                <div className="max-w-4xl mx-auto">
                  <p className="text-xs leading-relaxed">
                    <strong>Legal Disclaimer & License:</strong> CodeFusion services are provided "as-is" without warranty of any kind. 
                    ...
                    resulting from service interruptions, data loss, feature limitations, or any consequential damages. 
                    This software is licensed under a proprietary license and users are granted a limited, non-exclusive, 
                    non-transferable right to use the service. Any unauthorized use, reproduction, or distribution is prohibited.
                  </p>
                </div>
                <div className="flex justify-center space-x-6 text-xs">
                  ...
                  <a href="#" className="hover:text-[#6366f1] transition-colors">License Agreement</a>
